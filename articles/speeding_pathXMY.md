...
using the `speedingESJT` dataset — an **EXSJT** (Elaborated &
eXperimental Situational Judgment Test) in which a single driving
scenario was randomly varied across six factors, and each participant
rated three speed-choice actions on eight expected outcomes. Two
moderators are examined: **time pressure** (a situation-level factor
randomly assigned to each respondent) and **self-reported fast-driver
tendency** (a person-level trait).
...
1.  **Total effect.** The unmediated `Speed → Likelihood` slope — the
    single number that everything that follows is an account of.
...
steps exactly, with the moderator’s path-weight shifts (`BZ_MX × B1_YM`,
`B1_MX × BZ_YM`, `BZ_YX_joint`) playing the role of the
...
### Indexing the total effect (here: imagined speeding on action likelihood)
...
#> 1     <NA> B1_YX -0.2759434 0.02877604 -9.589346      0 -0.3323434 -0.2195434
```

`B1_YX ≈ -.28`, with a 95% CI of roughly \[-.33, -.22\]. On the `[0, 1]`
...
``` math
\beta^*_{1_{YX}} \;=\; \beta_{1_{MX}} \cdot \beta_{1_{YM}}
\;+\; \beta_{1_{YX}}
```
...
``` math
\beta^*_{1_{YX}} \;=\; \sum_{M} \beta_{1_{MX}} \cdot \beta_{1_{YM}}
\;+\; \beta_{1_{YX}}
```

Each term:

- **Term 0** (`B1_YX_total`, on the left): the total normative `X → Y`
  effect — the value we indexed above.
- **Term 1** (`B1_MX × B1_YM`): the **indirect effect** through one
...
- **Term 2** (`B1_YX`): the **residual direct effect** after the
  mediator(s) are accounted for. In the single-mediator case this is the
  loop fit’s `B1_YX` (a residual controlling only for that one
  mediator); in the multi-mediator case it is `B1_YX_joint`, the joint
  fit’s residual after controlling for every measured mediator
...
$`a = \beta_{1_{MX}}`$, $`b = \beta_{1_{YM}}`$, $`c' = \beta_{1_{YX}}`$,
and the total $`c`$ is $`\beta^*_{1_{YX}}`$.
...
- $`\beta_{1_{MX}}`$ is the **expectancy** arm — how strongly imagining
  ...
  produces `M`.
- $`\beta_{1_{YM}}`$ is the **value** arm — how strongly the expected
  ...
  outcomes with a steeper `B1_YM` are the ones the respondent
  effectively cares about.

The product $`\beta_{1_{MX}} \cdot \beta_{1_{YM}}`$ is then the indirect
...
$`\beta_{1_{MX}}`$ is positive (the expectancy arm). On the choice side,
respondents who expect to be on time are more likely to report they
would do the action, so $`\beta_{1_{YM}}`$ is also positive (the value
...
norm$tidy_loop
#>       mediator         param          est          se            z       pvalue    ci.lower      ci.upper
#> 1    MoneyCost         B1_MX  0.139240506 0.015158866   9.18541709 0.000000e+00  0.10952968  0.1689513376
#> 2    MoneyCost         B1_YX -0.227565820 0.031873868  -7.13957333 9.361401e-13 -0.29003745 -0.1650941859
#> 3    MoneyCost         B1_YM -0.371345477 0.085047044  -4.36635373 1.263378e-05 -0.53803462 -0.2046563341
#> 4    MoneyCost B1_MX * B1_YM -0.051706332 0.013892826  -3.72180087 1.978070e-04 -0.07893577 -0.0244768934
#> 5     FunDrive         B1_MX  0.001582278 0.016507440   0.09585245 9.236378e-01 -0.03077171  0.0339362659
#> 6     FunDrive         B1_YX -0.280416609 0.026692098 -10.50560395 0.000000e+00 -0.33273216 -0.2281010584
#> 7     FunDrive         B1_YM  0.723296874 0.071036222  10.18208535 0.000000e+00  0.58406844  0.8625253108
#> 8     FunDrive B1_MX * B1_YM  0.001144457 0.011934744   0.09589289 9.236056e-01 -0.02224721  0.0245361263
#> 9   IntQuality         B1_MX  0.007120253 0.015298411   0.46542436 6.416276e-01 -0.02286408  0.0371045881
#> 10  IntQuality         B1_YX -0.282914235 0.027562230 -10.26456263 0.000000e+00 -0.33693521 -0.2288932573
#> 11  IntQuality         B1_YM  0.511510383 0.084549838   6.04980911 1.450176e-09  0.34579574  0.6772250213
#> 12  IntQuality B1_MX * B1_YM  0.003642083 0.007720233   0.47175825 6.370994e-01 -0.01148929  0.0187734612
#> 13 Appropriate         B1_MX -0.446202532 0.021400025 -20.85056166 0.000000e+00 -0.48814581 -0.4042592542
#> 14 Appropriate         B1_YX  0.012236624 0.044294609   0.27625538 7.823519e-01 -0.07457921  0.0990524629
#> 15 Appropriate         B1_YM  0.653310448 0.070525986   9.26340048 0.000000e+00  0.51508206  0.7915388398
#> 16 Appropriate B1_MX * B1_YM -0.291508776 0.035491119  -8.21356960 2.220446e-16 -0.36107009 -0.2219474610
#> 17      OnTime         B1_MX  0.240506329 0.017710393  13.57995446 0.000000e+00  0.20579460  0.2752180614
#> 18      OnTime         B1_YX -0.365904773 0.033057871 -11.06861274 0.000000e+00 -0.43069701 -0.3011125363
#> 19      OnTime         B1_YM  0.360209319 0.077202862   4.66575085 3.074921e-06  0.20889449  0.5115241485
#> 20      OnTime B1_MX * B1_YM  0.086632621 0.020385649   4.24968674 2.140697e-05  0.04667748  0.1265877584
#> 21       Crash         B1_MX  0.306170886 0.015427231  19.84613313 0.000000e+00  0.27593407  0.3364077038
#> 22       Crash         B1_YX -0.071610295 0.038298221  -1.86980735 6.151058e-02 -0.14667343  0.0034528386
#> 23       Crash         B1_YM -0.678254746 0.072501616  -9.35502933 0.000000e+00 -0.82035530 -0.5361541894
#> 24       Crash B1_MX * B1_YM -0.207661857 0.024139694  -8.60250593 0.000000e+00 -0.25497479 -0.1603489267
#> 25     Injured         B1_MX  0.303797468 0.015914442  19.08941984 0.000000e+00  0.27260573  0.3349892019
#> 26     Injured         B1_YX -0.076444825 0.039378362  -1.94129013 5.222310e-02 -0.15362500  0.0007353459
#> 27     Injured         B1_YM -0.667639952 0.082401626  -8.10226668 4.440892e-16 -0.82914417 -0.5061357317
#> 28     Injured B1_MX * B1_YM -0.202827327 0.027360844  -7.41305093 1.234568e-13 -0.25645360 -0.1492010590
#> 29      Ticket         B1_MX  0.551424051 0.017281272  31.90876602 0.000000e+00  0.51755338  0.5852947205
#> 30      Ticket         B1_YX  0.020471755 0.050581131   0.40473106 6.856752e-01 -0.07866544  0.1196089496
#> 31      Ticket         B1_YM -0.543581489 0.070950310  -7.66143926 1.842970e-14 -0.68264154 -0.4045214374
#> 32      Ticket B1_MX * B1_YM -0.299743907 0.039987083  -7.49601834 6.572520e-14 -0.37811715 -0.2213706643
...
norm$tidy_joint
#>       mediator       param          est         se            z       pvalue    ci.lower    ci.upper
#> 1    MoneyCost B1_MX_joint  0.139240506 0.01515887   9.18541709 0.000000e+00  0.10952968  0.16895134
#> 2    MoneyCost B1_YM_joint -0.028927061 0.07320582  -0.39514699 6.927344e-01 -0.17240784  0.11455372
#> 3     FunDrive B1_MX_joint  0.001582278 0.01650744   0.09585245 9.236378e-01 -0.03077171  0.03393627
#> 4     FunDrive B1_YM_joint  0.409776446 0.08097880   5.06029284 4.186131e-07  0.25106091  0.56849198
#> 5   IntQuality B1_MX_joint  0.007120253 0.01529841   0.46542436 6.416276e-01 -0.02286408  0.03710459
#> 6   IntQuality B1_YM_joint  0.014019165 0.08574465   0.16349901 8.701256e-01 -0.15403726  0.18207559
#> 7  Appropriate B1_MX_joint -0.446202532 0.02140002 -20.85056166 0.000000e+00 -0.48814581 -0.40425925
#> 8  Appropriate B1_YM_joint  0.382971737 0.07541720   5.07804231 3.813438e-07  0.23515674  0.53078673
#> 9       OnTime B1_MX_joint  0.240506329 0.01771039  13.57995446 0.000000e+00  0.20579460  0.27521806
#> 10      OnTime B1_YM_joint  0.226702427 0.07298069   3.10633448 1.894223e-03  0.08366291  0.36974195
#> 11       Crash B1_MX_joint  0.306170886 0.01542723  19.84613313 0.000000e+00  0.27593407  0.33640770
#> 12       Crash B1_YM_joint -0.266502254 0.09407779  -2.83278594 4.614427e-03 -0.45089134 -0.08211316
#> 13     Injured B1_MX_joint  0.303797468 0.01591444  19.08941984 0.000000e+00  0.27260573  0.33498920
#> 14     Injured B1_YM_joint -0.094829812 0.10293282  -0.92127872 3.569049e-01 -0.29657442  0.10691480
#> 15      Ticket B1_MX_joint  0.551424051 0.01728127  31.90876602 0.000000e+00  0.51755338  0.58529472
#> 16      Ticket B1_YM_joint -0.121664879 0.08560263  -1.42127508 1.552368e-01 -0.28944294  0.04611318
#> 17        <NA> B1_YX_joint  0.017860284 0.05948115   0.30026797 7.639728e-01 -0.09872063  0.13444120
```
...
|  | Expectation paths (B1_MX: Speed → M) |  |  |  | Valuation paths (B1_YM: M → Likelihood) |  |  |  |
|----|----|----|----|----|----|----|----|----|
...
mediator column are `B1_MX`; edges right are `B1_YM`. Mediator node
fills show each `B1_MX` directly (red = expected outcome drops with
...
`-.28` indexed
[above](#indexing-the-total-effect-here-imagined-speeding-on-action-likelihood)
...
(`B1_YX_joint ≈ +.02`, *p* ≈ .76) is essentially zero: all eight
...
`Speed → Likelihood` arrow is the single global `B1_YX_joint` residual
direct path.
...
The residual `B1_YX_joint ≈ +.02` (the labeled center arrow) is the
...
joint residual `BZ_YX_joint`. The normative [decomposition
...
`M`’s expected level (`BZ_MX × B1_YM`) and through how strongly `M` is
weighted (`B1_MX × BZ_YM`).
...
**Term 0** (`BZ_YX`): This value, on the left-hand-side of the equation,
indicates the total degree to which the variable `X` moderates the
likelihood of doing the action (here: speeding). - **Term 1**
(`BZ_MX × B1_YM`): `Z` shifts *the degree to which `X` is expected to
affect `M`* — the **expectation** route, which affects the likelihood of
doing the action if `M` tends to be valued. - **Term 2**
(`B1_MX × BZ_YM`): `Z` shifts *how much outcome `M` affects `Y`* — the
**valuation** route, which effects the action likelihood if `X` tends to
affect `M`. - **Term 3** (`BZ_YX`): the residual moderation of the
...
the initial `BZ_YX` term prior to considering the mediator. It will not
be exactly equal for reasons detailed by Muller, Judd, & Yzerbyt,
(2005) - although the decomposition will tend to be very close.

When a moderator produces a large (`BZ_MX × B1_YM`) or (`B1_MX × BZ_YM`)
effect, this can be described as formally indicating a *reason* for the
behavior.

#### Schematic of the moderated decomposition

The same E×V schematics from the normative section carry over once a
moderator `Z` is in the field — every coefficient gains a “+ bZ”
companion that captures how `Z` shifts that arm. To match the
[field-style convention](#field-style-diagrams) used later in this
section, every fragment colored **limegreen** is a bZ term (the part of
an arm that varies with `Z`); the leading b1 term stays black.

``` r

## Local helpers for the three moderation schematics below. Wrap a
## fragment in limegreen to flag it as a bZ coefficient, and in light
## gray to fade it into "not part of this term".
## Note: starred-total betas use &#42; (HTML numeric entity for `*`)
...
green <- "#32CD32"; gray <- "#E5E5E5"
gz <- function(s) paste0("<span style='color:", green, "'>", s, "</span>")
gr <- function(s) paste0("<span style='color:", gray,  "'>", s, "</span>")

b1_MX <- "&beta;<sub>1<sub>MX</sub></sub>"
b1_YM <- "&beta;<sub>1<sub>YM</sub></sub>"
b1_YX <- "&beta;<sub>1<sub>YX</sub></sub>"
bZ_MX <- "&beta;<sub>Z<sub>MX</sub></sub>"
bZ_YM <- "&beta;<sub>Z<sub>YM</sub></sub>"
bZ_YX <- "&beta;<sub>Z<sub>YX</sub></sub>"

b1s_YX <- "&beta;&#42;<sub>1<sub>YX</sub></sub>"   # starred b1 (total)
bZs_YX <- "&beta;&#42;<sub>Z<sub>YX</sub></sub>"   # starred bZ (total)
```
...
unmediated `X → Y` slope ($`\beta^*_{1_{YX}}`$) and how that slope is
shifted by `Z` ($`\beta^*_{Z_{YX}}`$). The whole “Term 0” of the
identity above is what the green fragment names.

``` r

plotPathSchema(
  XY_label = paste0(b1s_YX, " ", gz(paste0("+&nbsp;", bZs_YX))),
  X_shape  = "rtTri",
  Y_shape  = "lfTri"
)
```
...
the picture, each of the three arms carries its own b1+bZ pair: the b1
piece is the arm as fit at the average level of `Z`, and the bZ piece is
...
plotPathSchema(
  M_label  = "M",
  XM_label = paste0(b1_MX, " ", gz(paste0("+&nbsp;", bZ_MX))),
  MY_label = paste0(b1_YM, " ", gz(paste0("+&nbsp;", bZ_YM))),
  XY_label = paste0(b1_YX, " ", gz(paste0("+&nbsp;", bZ_YX))),
  X_shape  = "rtTri",
  Y_shape  = "lfTri"
)
```
...
term being indexed. Active b1 terms stay black, active bZ terms stay
limegreen, and arrows whose color matches their label are the ones
...
## (b1, bZ) is active and the other is faded.
arm_lab <- function(b1, bZ, active = c("b1", "bZ")) {
  active <- match.arg(active)
  if (active == "b1") paste0(b1,     " ", gr(paste0("+&nbsp;", bZ)))
  else                paste0(gr(b1), " ", gz(paste0("+&nbsp;", bZ)))
}
## And a fully faded label (whole "b1 + bZ" string wrapped in gray).
arm_off <- function(b1, bZ) gr(paste0(b1, " +&nbsp;", bZ))

## Panel 1: BZ_MX * B1_YM (expectation-route moderation).
p1 <- plotPathSchema(
  M_label  = "M",
  XM_label = arm_lab(b1_MX, bZ_MX, "bZ"),   # bZ active -> green line
  MY_label = arm_lab(b1_YM, bZ_YM, "b1"),   # b1 active -> black line
  XY_label = arm_off(b1_YX, bZ_YX),         # not in this term
  X_shape  = "rtTri", Y_shape = "lfTri",
  XM_color = green, MY_color = "black", XY_color = gray,
  title    = "Term 1:  &beta;<sub>Z<sub>MX</sub></sub> &middot; &beta;<sub>1<sub>YM</sub></sub>"
) + ggplot2::theme(plot.title = ggtext::element_markdown(hjust = 0.5))

## Panel 2: B1_MX * BZ_YM (valuation-route moderation).
p2 <- plotPathSchema(
  M_label  = "M",
  XM_label = arm_lab(b1_MX, bZ_MX, "b1"),
  MY_label = arm_lab(b1_YM, bZ_YM, "bZ"),
  XY_label = arm_off(b1_YX, bZ_YX),
  X_shape  = "rtTri", Y_shape = "lfTri",
  XM_color = "black", MY_color = green, XY_color = gray,
  title    = "Term 2:  &beta;<sub>1<sub>MX</sub></sub> &middot; &beta;<sub>Z<sub>YM</sub></sub>"
) + ggplot2::theme(plot.title = ggtext::element_markdown(hjust = 0.5))

## Panel 3: BZ_YX (residual direct moderation).
p3 <- plotPathSchema(
  M_label  = "M",
  XM_label = arm_off(b1_MX, bZ_MX),
  MY_label = arm_off(b1_YM, bZ_YM),
  XY_label = arm_lab(b1_YX, bZ_YX, "bZ"),
  X_shape  = "rtTri", Y_shape = "lfTri",
  XM_color = gray, MY_color = gray, XY_color = green,
  title    = "Term 3:  &beta;<sub>Z<sub>YX</sub></sub>"
) + ggplot2::theme(plot.title = ggtext::element_markdown(hjust = 0.5))
...
need *one* bZ arm paired with the surviving b1 on the other arm —
expectation-route moderation operates through `Z` shifting `B1_MX` while
the average valuation `B1_YM` does the carrying, and the valuation route
is the mirror image. Term 3 is what `Z` does *directly* to `Y` once the
indirect routes are accounted for. The three terms sum to (an
approximation of) the green Term-0 arrow in Figure 1.
...
plotsAsWidget(
  list(p1, p2, p3),
  panel_titles = c(
    "Term 1: B_Z_MX * B_1_YM (expectation route)",
    "Term 2: B_1_MX * B_Z_YM (valuation route)",
    "Term 3: B_Z_YX (residual direct)"
  ),
  width  = 7,
  height = 3.5,
  format = "svg"
...
![Term 1: B_Z_MX \* B_1_YM (expectation
route)](data:image/svg+xml;base64,)![Term
2: B_1_MX \* B_Z_YM (valuation
route)](data:image/svg+xml;base64,)![Term
3: B_Z_YX (residual
direct)](data:image/svg+xml;base64,)
...
fits both the no-mediator model (giving just `BZ_YX`) and the full
...
Total moderation BZ_YX\[1\] (no mediator) {.table}
...
kable0(dec$components, digits = 3,
             caption = "Decomposition of BZ_YX[1] through each single mediator")
```

| mediator    | term           |   est |   se |      z | pvalue |
|:------------|:---------------|------:|-----:|-------:|-------:|
| MoneyCost   | BZ_MX \* B1_YM |  .011 | .005 |  2.178 |   .029 |
| MoneyCost   | B1_MX \* BZ_YM |  .013 | .012 |  1.049 |   .294 |
| MoneyCost   | BZ_YX (direct) |  .235 | .030 |  7.812 |   .000 |
| MoneyCost   | sum (1+2+3)    |  .259 |   NA |     NA |     NA |
| FunDrive    | BZ_MX \* B1_YM |  .039 | .011 |  3.704 |   .000 |
| FunDrive    | B1_MX \* BZ_YM |  .000 | .001 |   .000 |  1.000 |
| FunDrive    | BZ_YX (direct) |  .212 | .027 |  7.975 |   .000 |
| FunDrive    | sum (1+2+3)    |  .251 |   NA |     NA |     NA |
| IntQuality  | BZ_MX \* B1_YM |  .013 | .007 |  1.719 |   .086 |
| IntQuality  | B1_MX \* BZ_YM |  .000 | .001 |   .439 |   .661 |
| IntQuality  | BZ_YX (direct) |  .239 | .027 |  8.790 |   .000 |
| IntQuality  | sum (1+2+3)    |  .252 |   NA |     NA |     NA |
| Appropriate | BZ_MX \* B1_YM |  .073 | .016 |  4.442 |   .000 |
| Appropriate | B1_MX \* BZ_YM | -.001 | .031 |  -.036 |   .971 |
| Appropriate | BZ_YX (direct) |  .181 | .038 |  4.815 |   .000 |
| Appropriate | sum (1+2+3)    |  .253 |   NA |     NA |     NA |
| OnTime      | BZ_MX \* B1_YM |  .004 | .006 |   .670 |   .503 |
| OnTime      | B1_MX \* BZ_YM |  .028 | .017 |  1.618 |   .106 |
| OnTime      | BZ_YX (direct) |  .222 | .034 |  6.556 |   .000 |
| OnTime      | sum (1+2+3)    |  .254 |   NA |     NA |     NA |
| Crash       | BZ_MX \* B1_YM |  .038 | .010 |  3.994 |   .000 |
| Crash       | B1_MX \* BZ_YM | -.024 | .020 | -1.220 |   .223 |
| Crash       | BZ_YX (direct) |  .237 | .032 |  7.366 |   .000 |
| Crash       | sum (1+2+3)    |  .250 |   NA |     NA |     NA |
| Injured     | BZ_MX \* B1_YM |  .038 | .009 |  4.032 |   .000 |
| Injured     | B1_MX \* BZ_YM | -.002 | .030 |  -.076 |   .940 |
| Injured     | BZ_YX (direct) |  .217 | .036 |  5.994 |   .000 |
| Injured     | sum (1+2+3)    |  .253 |   NA |     NA |     NA |
| Ticket      | BZ_MX \* B1_YM |  .033 | .010 |  3.226 |   .001 |
| Ticket      | B1_MX \* BZ_YM |  .022 | .032 |   .674 |   .500 |
| Ticket      | BZ_YX (direct) |  .200 | .044 |  4.579 |   .000 |
| Ticket      | sum (1+2+3)    |  .255 |   NA |     NA |     NA |

Decomposition of BZ_YX\[1\] through each single mediator {.table}
...
expectation-route is through `Appropriate`: `BZ_MX × B1_YM = .073`. Term
...
|  | Fast-driver moderation: expectation arm (BZ_MX) |  |  |  | Fast-driver moderation: valuation arm (BZ_YM) |  |  |  |
|----|----|----|----|----|----|----|----|----|
| Mediator | est | se | z | p | est | se | z | p |
...
as the normative field above, but with each `B1` swapped for its `BZ`
...
BZ magnitudes are typically smaller than B1’s.
...
On the **expectation** side (`BZ_MX`), self-described fast drivers
...
mean `|bZ|` is essentially equal to that on the expectation arm — but
...
`Speed → Likelihood` path by `BZ_YX[1]` **= +.25**, and these
...
below directly. Following the package’s new color convention — limegreen
for anything that is a pure `bZ` coefficient — each route panel renders
one arm in green and the other in black:

- **Expectation panel:** `BZ_MX(SRFast)` on the green left arm, `B1_YM`
  on the black right arm. A green-black chain through a mediator says
  fast drivers’ *expectations* of speeding’s outcomes shift on that
  mediator AND those outcomes carry weight for action.
- **Valuation panel:** `B1_MX` on the black left arm, `BZ_YM(SRFast)` on
  the green right arm. A black-green chain says speeding *produces* that
  outcome AND fast drivers *weight* it differently.
...
have visible weight. The mean `|bZ|` across mediators is in fact
essentially identical on the two arms (about .06 each).

What differs across panels is *precision*. The standard errors on the
valuation-arm `BZ_YM` coefficients run roughly 4× the standard errors on
the expectation-arm `BZ_MX` coefficients in this fit:

``` r

bzmx <- subset(mod_p$tidy_loop,
               param == "BZ_MX" & !is.na(mediator))[, c("mediator","est","se","pvalue")]
bzym <- subset(mod_p$tidy_loop,
               param == "BZ_YM" & !is.na(mediator))[, c("mediator","est","se","pvalue")]
names(bzmx)[2:4] <- c("BZ_MX","SE_MX","p_MX")
names(bzym)[2:4] <- c("BZ_YM","SE_YM","p_YM")
cmp <- merge(bzmx, bzym, by = "mediator")
cmp$SE_ratio <- cmp$SE_YM / cmp$SE_MX
kable0(cmp, digits = 3,
  caption = paste0("Per-mediator comparison of expectation-arm (BZ_MX) and ",
                   "valuation-arm (BZ_YM) moderation coefficients. ",
                   "Mean |BZ| is similar across arms (",
                   sprintf("%.3f", mean(abs(cmp$BZ_MX))), " vs ",
                   sprintf("%.3f", mean(abs(cmp$BZ_YM))),
                   ") but mean SE differs by ",
                   sprintf("%.1fx", mean(cmp$SE_YM) / mean(cmp$SE_MX)),
                   "."))
```

| mediator    | BZ_MX | SE_MX | p_MX | BZ_YM | SE_YM | p_YM | SE_ratio |
|:------------|------:|------:|-----:|------:|------:|-----:|---------:|
...
Per-mediator comparison of expectation-arm (BZ_MX) and valuation-arm
(BZ_YM) moderation coefficients. Mean \|BZ\| is similar across arms
...
estimate `BZ_MX`. `M`, by contrast, is each respondent’s *rating* of an
...
used to estimate `BZ_YM`. The effective sample of informative persons is
therefore everyone for `BZ_MX` but only the subset whose `M` actually
moves with `Speed` for `BZ_YM` — and that latter subset can be small
...
![Expectation route (BZ_MX(SRFast),
B1_YM)](data:image/svg+xml;base64,)![Valuation
route (B1_MX,
BZ_YM(SRFast))](data:image/svg+xml;base64,)
...
|  | Expectation route (BZ_MX × B1_YM) |  |  |  | Valuation route (B1_MX × BZ_YM) |  |  |  |
|----|----|----|----|----|----|----|----|----|
| Mediator | est | se | z | p | est | se | z | p |
...
- Nodes are colored by their **expected score when X is held at 1** on a
  ...
  each mediator is colored by its `B1_MX` coefficient; Y is colored by
...
- Edges are **dashed for negative**, **solid for positive**, with
  ...
  labels show the full `b1 + bZ(Z)` form. Arrowheads are clipped to the
  node perimeter.
...
by `SRFast` (≈ +.00). The residual `BZ_YX[2]` direct path (+.18)
...
parameters under the `_joint` suffix. The most useful of these are the
...
|:----|:------------|------:|-----:|------:|-------:|---------:|---------:|
| 33  | B1_YX_joint | -.046 | .058 | -.788 |   .430 |    -.159 |     .068 |
| 34  | BZ_YX_joint |  .155 | .052 | 2.998 |   .003 |     .054 |     .257 |
...
earlier in this section flagged `BZ_YX[2]` as substantial (≈ .18-.24)
...
BZ_YM (valuation moderation) per mediator: loop vs joint, with SE
...
The no-mediator coefficient `BZ_YX[1]` from a fit with trait `T` as the
...
These correlations track the formal `BZ_YX[1]` from a full
[`pathXMY_decompose()`](https://dustin-wood.github.io/funfield/reference/pathXMY_decompose.md)
...
[`?pathXMY`](https://dustin-wood.github.io/funfield/reference/pathXMY.md)),
so its reported `BZ_YX[1]` is the slope expressed per *SD* of $`T`$
rather than per raw unit of $`T`$:
``` math
\mathrm{BZ\_YX}[1] \;=\; \hat{\beta}_{\Delta L \sim T} \cdot \mathrm{SD}(T)
                       \;=\; r \cdot \mathrm{SD}(\Delta L).
```
The $`\mathrm{SD}(T)`$ cancels, which is why the ratio
$`\mathrm{BZ\_YX}[1] / r`$ is the same across items even though items
differ in their raw response variances. In this fit
$`\mathrm{SD}(\Delta L) \approx .51`$, so the empirical relationship is
$`\mathrm{BZ\_YX}[1] \approx .51 \times r`$, with the constant being
just the variability of the per-person Speed effect in this sample. For
...
`B1_YM[OnTime]` answers a fairly specific empirical question: how much
...
dec_lot <- pathXMY_decompose(dat_lot, X = "Speed", Y = "Likelihood",
                             ...
                             Z.within = FALSE)
kable0(
  subset(dec_lot$components, mediator == "OnTime"),
  digits = 3,
...
|     | mediator | term           |   est |   se |      z | pvalue |
|:----|:---------|:---------------|------:|-----:|-------:|-------:|
| 17  | OnTime   | BZ_MX \* B1_YM |  .002 | .006 |   .277 |   .781 |
| 18  | OnTime   | B1_MX \* BZ_YM |  .052 | .020 |  2.572 |   .010 |
| 19  | OnTime   | BZ_YX (direct) | -.115 | .036 | -3.206 |   .001 |
| 20  | OnTime   | sum (1+2+3)    | -.061 |   NA |     NA |     NA |

OnTime decomposition under Z = liking to arrive at appointments in
plenty of time {.table}

Term 1 (`BZ_MX × B1_YM ≈ +.002`, *p* = .78) is essentially zero —
...
rater wants. Term 2 (`B1_MX × BZ_YM = +.052`, *p* = .01) is
...
[`pathXMY_decompose()`](https://dustin-wood.github.io/funfield/reference/pathXMY_decompose.md),
this valuation-route reason would be invisible in the standard `BZ_MX`
table.
...
barely budges (`BZ_MX` is null), while the `OnTime -> Likelihood` edge
...
The structural alignment between the item and `B1_YM[OnTime]` is part of
...
`B1_YX` path — the direct link from X = “drive over the limit” to Y =
...
Total moderation BZ_YX\[1\] by time pressure (no mediator) {.table}
...
kable0(dec_s$components, digits = 3,
             caption = "Decomposition of the time-pressure moderation through each single mediator")
```

| mediator    | term           |   est |   se |      z | pvalue |
|:------------|:---------------|------:|-----:|-------:|-------:|
| MoneyCost   | BZ_MX \* B1_YM | -.006 | .006 | -1.114 |   .265 |
| MoneyCost   | B1_MX \* BZ_YM | -.018 | .011 | -1.648 |   .099 |
| MoneyCost   | BZ_YX (direct) |  .066 | .030 |  2.239 |   .025 |
| MoneyCost   | sum (1+2+3)    |  .042 |   NA |     NA |     NA |
| FunDrive    | BZ_MX \* B1_YM | -.002 | .012 |  -.183 |   .855 |
| FunDrive    | B1_MX \* BZ_YM |  .000 | .000 |   .094 |   .925 |
| FunDrive    | BZ_YX (direct) |  .043 | .025 |  1.732 |   .083 |
| FunDrive    | sum (1+2+3)    |  .041 |   NA |     NA |     NA |
| IntQuality  | BZ_MX \* B1_YM |  .026 | .008 |  3.108 |   .002 |
| IntQuality  | B1_MX \* BZ_YM | -.000 | .001 |  -.373 |   .709 |
| IntQuality  | BZ_YX (direct) |  .015 | .026 |   .570 |   .569 |
| IntQuality  | sum (1+2+3)    |  .041 |   NA |     NA |     NA |
| Appropriate | BZ_MX \* B1_YM |  .025 | .014 |  1.857 |   .063 |
| Appropriate | B1_MX \* BZ_YM | -.033 | .033 | -1.002 |   .316 |
| Appropriate | BZ_YX (direct) |  .049 | .043 |  1.150 |   .250 |
| Appropriate | sum (1+2+3)    |  .042 |   NA |     NA |     NA |
| OnTime      | BZ_MX \* B1_YM |  .031 | .009 |  3.459 |   .001 |
| OnTime      | B1_MX \* BZ_YM | -.024 | .018 | -1.290 |   .197 |
| OnTime      | BZ_YX (direct) |  .030 | .031 |   .973 |   .331 |
| OnTime      | sum (1+2+3)    |  .038 |   NA |     NA |     NA |
| Crash       | BZ_MX \* B1_YM | -.004 | .010 |  -.361 |   .718 |
| Crash       | B1_MX \* BZ_YM | -.017 | .019 |  -.878 |   .380 |
| Crash       | BZ_YX (direct) |  .063 | .038 |  1.656 |   .098 |
| Crash       | sum (1+2+3)    |  .043 |   NA |     NA |     NA |
| Injured     | BZ_MX \* B1_YM | -.006 | .011 |  -.590 |   .555 |
| Injured     | B1_MX \* BZ_YM | -.016 | .021 |  -.752 |   .452 |
| Injured     | BZ_YX (direct) |  .065 | .037 |  1.739 |   .082 |
| Injured     | sum (1+2+3)    |  .043 |   NA |     NA |     NA |
| Ticket      | BZ_MX \* B1_YM |  .006 | .009 |   .637 |   .524 |
| Ticket      | B1_MX \* BZ_YM | -.075 | .040 | -1.867 |   .062 |
| Ticket      | BZ_YX (direct) |  .114 | .051 |  2.223 |   .026 |
...
|  | Time-pressure moderation: expectation arm (BZ_MX) |  |  |  | Time-pressure moderation: valuation arm (BZ_YM) |  |  |  |
|----|----|----|----|----|----|----|----|----|
| Mediator | est | se | z | p | est | se | z | p |
