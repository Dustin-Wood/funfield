...
-   Wood, D. (in press). Formally representing how psychological processes shape actions and one another using functional fields. In D. Wood, S. J. Read, P. D. Harms, & A. Slaughter (Eds.), *Measuring and Modeling Persons and Situations.* Elsevier. ([preprint](https://psyarxiv.com/nj3wf/))
