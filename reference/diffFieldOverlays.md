...
moderator variable has a level of '1' (often: 1=TRUE, or Z = +1 standard
deviation)
...
Moderators should be specified as y ~ x:mod rather than as y ~ mod:x (as
this function assigns what follows ':' as the moderator variable).
